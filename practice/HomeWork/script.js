...
const numbers1 = [10, 20, 50, 90, 100, 150];

const sumArray = (numbers1) => {
    return numbers1.reduce((tempSum1, b) => tempSum1 + b, 0);
}
console.log(sumArray(numbers1));
console.log(" ");

/*// Array.reduce()
// 2.1. Parašykite programą kuri suskaičiuos numbers bendrą skaičių sumą.
const numbers1 = [10, 20, 50, 90, 100, 150];

const sumArray = (numbers1) => {
    return numbers1.reduce((tempSum, a) => tempSum + a, 0);
}
console.log(sumArray(numbers1));
console.log(" ");
...
const totalArea = (cities) => {
    return cities.reduce((tempSum, a) => tempSum + a.area, 0);
}
console.log(totalArea(cities));
console.log(" ");
...
const pushFruits = (fruits, fruit1, fruit2, fruit3) => {
    fruits.push(fruit1, fruit2, fruit3);
}

pushFruits(fruits, 'apple', 'banana', 'lemon');
console.log(fruits);
console.log(" ");
...
const pushCities = (cities4, city) => {
    cities4.push(city);
}
pushCities(cities4, { name: 'Nida', area: 1000 });
console.log(cities4);
console.log(" ");
